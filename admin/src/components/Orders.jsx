...
const Orders = () => {
  ...
  const handleStatusChange = ( orderId, newStatus) => {
    //console.log("new status",orderId, newStatus);
                        ...
                        return(
                          <div key={order.id} className="bg-white shadow-lg rounded-lg p-6 mb-6 transition-all">
                            ...
                            <div className="mt-4">
                              ...
                              <p><strong>Address : </strong> {order.shipping_info?.address}, {" "}
                                ...
                                Array.isArray(order.order_items) && order.order_items.map( item => {
                                  return(
                                    <div key={item.order_item_id} className="flex items-center gap-4 mb-2 border-b pb-2">
                                      {
                                        item.image && (
                                          <img src={item.image} alt ={item.title} className="w-16 h-16 object-cover cursor-pointer"
