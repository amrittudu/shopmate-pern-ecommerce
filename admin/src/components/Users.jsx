...
import { deleteUser,fetchAllUsers } from "../store/slices/adminSlice.js";
import { deleteOrder, fetchAllOrders, updateOrderStatus} from "../store/slices/orderSlice.js";
    ...
    <>
      <main className="p-[10px] pl-[10px] md:pl-[17rem] w-full">
        ...
        <div className="flex-1 md:p-6">
          ...
          <p className="text-sm text-gray-600 mb-6">Manage website's users.</p>
                  ...
                  <table className="min-w-full bg-white border border-gray-200">
                    <thead className="bg-blue-100 text-gray-700">
                      <tr>
                        ...
                        <th className="py-3 px-4 text-left">Registered No</th>
