...
import { toggleCreateProductModal, toggleUpdateProductModal, toggleViewProductModal } from "../store/slices/extraSlice.js";
import CreateProductModal from "../modals/CreateProductModal";
import Header from "./Header";
import UpdateProductModal from "../modals/UpdateProductModal";
import { toast } from "react-toastify";
import ViewProductModal from "../modals/ViewProductModal";
import { deleteProduct, fetchAllProducts } from "../store/slices/productsSlice.js"; 
const Products = () => {
  const [selectedProduct, setSelectedProduct] = useState(null);
  const [maxPage, setMaxPage] = useState(null);
  const [page, setPage] = useState(1);
  const dispatch = useDispatch();
  const { isViewProductModalOpened, isCreateProductModalOpened, isUpdateProductModalOpened
    ...
    <>
      <main className="p-[10px] pl-[10px] md:pl-[17rem] w-full">
        ...
        <div className="flex-1 md:p-6">
          ...
          <p className="text-sm text-gray-600 mb-6">Manage products.</p>
                ...
                !fetchingProducts && products.length > 0 && (
                  <div className="flex justify-center mt-6 gap-4">
                    <button
                      ...
                      disabled={page === 1}
                      className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded disabled:opacity-500"
                    >
                      Previous
                    </button>
