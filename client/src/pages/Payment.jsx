...
const Payment = () => {
  ...
  useEffect( () => {
    loadStripe(
      "pk_test_51TM82gJIwMXpZDdqDCnYvAW4B4EucOJYsBjMc7KolQEV9r67PyY48PdBHc9v0nulJzNAIuWZUiojAyn0knEkLuU500jjkvWQT0"
    )
      .then( (stripe) => setStripePromise(stripe))
      .catch( (error) => console.error("Failed to load Stripe:", error) );
    ...
    return (
      <div className="min-h-screen pt-20 flex items-center justify-center">
        <div className="text-center glass-panel max-w-md">
          ...
          >
            <span>Continue Shopping</span> <ArrowRight className="w-5 h-5"></ArrowRight>
          </Link>
        </div>
      </div>
    )
                ...
                <div className="glass-panel sticky top-24">
                  ...
                  <div className="space-y-2 border-t border-[hsla(var(--glass-border))] pt-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="dtext-green-500">
