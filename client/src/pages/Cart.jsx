                      ...
                      <div className="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-6">
                        ...
                        >
                          <img
                            ...
                            className="w-24 h-24 object-cover rounded-lg hover:scale-105 transition-transformer"
                            />
                        </Link>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="border-t border-[hsla(var(--glass-border))] pt-4">
                    <div className="flex justify-between">
                      ...
                      <span className="text-lg font-semibold">${( total + total * 0.18).toFixed(2) }</span>
                    </div>
                  </div>
