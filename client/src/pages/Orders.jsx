                  ...
                  filterOrders.map( (order) => {
                    return (
                      <div key={order.id} className="glass-card p-6">
                        {/* order header */}
                        <div className="flex flex-col md:flex-row md:items-center md:items-cener md:justify-between mb-6
                        ...
                        <div className="space-y-4">
                          {
                            order?.order_items?.map( (item) => {
                              return (
                                <div 
                                  key={item.product_id}
                                  className="flex items-center space-x-4 bg-secondary/50 rounded-lg"
                                >
                                  <img
                                    src={item.image}
                                    alt={item.title}
